...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;{'Fuse Safe'}&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a mobile
    ...
    <h4>4.1. When visiting our website and using {'Fuse Safe'}</h4>
    <p>
      When visiting our website or using {'Fuse Safe'}, we may collect and process personal data. The data will be
    ...
    <p>
      In addition, we may take a recording of you while testing {'Fuse Safe'} for internal and external use. The basis
    ...
    <p>
      {'Fuse Safe'} mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the {'Fuse Safe'} mobile app via biometrics information (touch ID or face ID). This
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with {`Fuse Safe`}. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>{'Fuse Safe – Privacy policy'}</title>
      </Head>
